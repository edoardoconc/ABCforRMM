    ...
    if (data_choice == 0)
      data = DataGeneration(dim,data_type,1000,1,1,dof=1,mean=0,sigma=1)
    ...
    prior_type = "DiggleGrattonProcess"
    ...
    save(SampledPosteriorWithABC, file = "lap1dataDiggleGrattonProcess.Rdata")
    ########################################################################
    ### Post-Processing ####################################################
